# Mundtlig disposition - 5 minutter

## 0:00-0:30 - Kort intro

- Jeg præsenterer portfolioet som mit eksamensprodukt.
- Jeg forklarer, at sitet viser projekter, proces, læring og refleksion fra 1. semester.
...
- Før: krav, overblik og indsamling af materiale.
- Under: designvalg, HTML, CSS, JavaScript og navigation.
- Efter: test, justering, refleksion og eksamensforberedelse.

## 4:30-5:00 - Afrunding

- Jeg fremhæver min vigtigste læring: et digitalt produkt skal både være teknisk forståeligt, brugervenligt, dokumenteret og fagligt begrundet.
- Jeg er klar til at vise kode, designvalg og konkrete eksempler fra projekterne.
